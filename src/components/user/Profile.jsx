...
const Profile = () => {
    ...
    const {ProfileDetails,ProfileDetailsRequest,ProfileSaveRequest,ProfileForm,ProfileFormChange} = UserStore();
                ...
                <div className="card p-5 rounded-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 p-2">
                            ...
                            <input value={ProfileForm.ship_fax} onChange={(e)=>{ProfileFormChange('ship_fax',e.target.value)}} type="text" className="form-control"/>
                        </div>
                        <div className="col-md-3 p-2">
                        ...
                        <div className="col-md-3 p-2">
                            ...
                            <input value={ProfileForm.ship_postcode} onChange={(e)=>{ProfileFormChange('cus_postcode',e.target.value)}} type="text" className="form-control"/>
                        </div>
                        <div className="col-md-3 p-2">
